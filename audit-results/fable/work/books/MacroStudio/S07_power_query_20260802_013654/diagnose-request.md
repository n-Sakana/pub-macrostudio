...
ください。`291d0938-cecb-4af4-8354-827942bc628d` はこの依頼に書かれた値のまま使います。
...
```
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d DIAG BEGIN 1
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d SECTION BEGIN PURPOSE
支店ごとの売上データを読み込み、月次の集計表を作って所定のフォルダへ保存するマクロです。
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d SECTION END PURPOSE
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d SECTION BEGIN FLOW
...
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d SECTION END FLOW
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d SECTION BEGIN DEPENDENCY
共有フォルダ上の「支店データ.xlsx」を開きます。
待ち時間の処理に Windows の Sleep 関数を使っています。
外部の参照ライブラリは使っていません。
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d SECTION END DEPENDENCY
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d SECTION BEGIN ENVIRONMENT
提示された環境では、Windows の関数を直接呼ぶ処理と、固定のドライブ文字を前提にした
ファイルの読み書きが、そのままでは動きません。集計そのものの処理は環境に依存していません。
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d SECTION END ENVIRONMENT
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d FINDING BEGIN 1
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d META CLASS=BLOCKER CONFIDENCE=CONFIRMED MODULE=CommonUtil PROC=WaitSeconds LINES=8,21 ENVKEY=WIN32API_BLOCKED
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d TEXT BEGIN TITLE
待ち時間の処理が Windows の関数を直接呼んでいるため、実行できません。
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d TEXT END TITLE
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d TEXT BEGIN CONDITION
このマクロを実行すると必ず通ります。分岐や設定で避けられる箇所ではありません。
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d TEXT END CONDITION
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d TEXT BEGIN IMPACT
マクロが最初の待ち時間で止まり、それ以降の集計も保存も行われません。
データが壊れることはありませんが、処理は完了しません。
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d TEXT END IMPACT
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d TEXT BEGIN EVIDENCE
...
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d TEXT END EVIDENCE
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d FINDING END 1
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d FINDING BEGIN 2
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d META CLASS=CONDITIONAL CONFIDENCE=LIKELY MODULE=MonthlyReport PROC=LoadSource LINES=42-47 ENVKEY=FIXED_DRIVE_LETTER
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d TEXT BEGIN TITLE
...
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d TEXT END EVIDENCE
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d FINDING END 2
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d DIAG COMPLETE 2
'@MACROSTUDIO 291d0938-cecb-4af4-8354-827942bc628d DIAG END
```
