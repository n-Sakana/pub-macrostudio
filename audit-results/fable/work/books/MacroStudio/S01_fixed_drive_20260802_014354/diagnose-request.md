...
ください。`ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d` はこの依頼に書かれた値のまま使います。
...
```
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d DIAG BEGIN 1
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d SECTION BEGIN PURPOSE
支店ごとの売上データを読み込み、月次の集計表を作って所定のフォルダへ保存するマクロです。
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d SECTION END PURPOSE
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d SECTION BEGIN FLOW
...
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d SECTION END FLOW
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d SECTION BEGIN DEPENDENCY
共有フォルダ上の「支店データ.xlsx」を開きます。
待ち時間の処理に Windows の Sleep 関数を使っています。
外部の参照ライブラリは使っていません。
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d SECTION END DEPENDENCY
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d SECTION BEGIN ENVIRONMENT
提示された環境では、Windows の関数を直接呼ぶ処理と、固定のドライブ文字を前提にした
ファイルの読み書きが、そのままでは動きません。集計そのものの処理は環境に依存していません。
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d SECTION END ENVIRONMENT
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d FINDING BEGIN 1
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d META CLASS=BLOCKER CONFIDENCE=CONFIRMED MODULE=CommonUtil PROC=WaitSeconds LINES=8,21 ENVKEY=WIN32API_BLOCKED
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d TEXT BEGIN TITLE
待ち時間の処理が Windows の関数を直接呼んでいるため、実行できません。
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d TEXT END TITLE
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d TEXT BEGIN CONDITION
このマクロを実行すると必ず通ります。分岐や設定で避けられる箇所ではありません。
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d TEXT END CONDITION
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d TEXT BEGIN IMPACT
マクロが最初の待ち時間で止まり、それ以降の集計も保存も行われません。
データが壊れることはありませんが、処理は完了しません。
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d TEXT END IMPACT
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d TEXT BEGIN EVIDENCE
...
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d TEXT END EVIDENCE
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d FINDING END 1
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d FINDING BEGIN 2
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d META CLASS=CONDITIONAL CONFIDENCE=LIKELY MODULE=MonthlyReport PROC=LoadSource LINES=42-47 ENVKEY=FIXED_DRIVE_LETTER
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d TEXT BEGIN TITLE
...
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d TEXT END EVIDENCE
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d FINDING END 2
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d DIAG COMPLETE 2
'@MACROSTUDIO ed1c516d-9cc5-4a3e-ad3f-213eaa47f65d DIAG END
```
